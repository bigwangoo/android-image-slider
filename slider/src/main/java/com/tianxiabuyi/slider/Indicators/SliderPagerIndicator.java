package com.tianxiabuyi.slider.Indicators;
 ...
 * Pager Indicator.
 */
public class SliderPagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener {

    private Context mContext;

    /**
     * bind this Indicator with {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx}
     */
    ...
    /**
     * This value is from {@link com.tianxiabuyi.slider.SliderAdapter} getRealCount() represent
     * <p>
    ...
    public SliderPagerIndicator(Context context, AttributeSet attrs) {
        ...
        final TypedArray attributes = context.obtainStyledAttributes(
                attrs, R.styleable.SliderPagerIndicator, 0, 0);
        int visibility = attributes.getInt(
                R.styleable.SliderPagerIndicator_slider_visibility, IndicatorVisibility.Visible.ordinal());
        ...
        int shape = attributes.getInt(R.styleable.SliderPagerIndicator_slider_shape, Shape.Oval.ordinal());
        ...
        mUserSetSelectedIndicatorResId = attributes.getResourceId(R.styleable.SliderPagerIndicator_slider_selected_drawable,
                0);
        mUserSetUnSelectedIndicatorResId = attributes.getResourceId(R.styleable.SliderPagerIndicator_slider_unselected_drawable,
                0);

        mDefaultSelectedColor = attributes.getColor(R.styleable.SliderPagerIndicator_slider_selected_color, Color.rgb(255, 255, 255));
        mDefaultUnSelectedColor = attributes.getColor(R.styleable.SliderPagerIndicator_slider_unselected_color, Color.argb(33, 255, 255, 255));

        mDefaultSelectedWidth = attributes.getDimension(R.styleable.SliderPagerIndicator_slider_selected_width, (int) pxFromDp(6));
        mDefaultSelectedHeight = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_selected_height, (int) pxFromDp(6));

        mDefaultUnSelectedWidth = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_unselected_width, (int) pxFromDp(6));
        mDefaultUnSelectedHeight = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_unselected_height, (int) pxFromDp(6));

        mSelectedGradientDrawable = new GradientDrawable();
        mUnSelectedGradientDrawable = new GradientDrawable();

        mPadding_left = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_padding_left, (int) pxFromDp(3));
        mPadding_right = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_padding_right, (int) pxFromDp(3));
        mPadding_top = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_padding_top, (int) pxFromDp(0));
        mPadding_bottom = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_padding_bottom, (int) pxFromDp(0));

        mSelectedPadding_Left = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_selected_padding_left, (int) mPadding_left);
        mSelectedPadding_Right = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_selected_padding_right, (int) mPadding_right);
        mSelectedPadding_Top = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_selected_padding_top, (int) mPadding_top);
        mSelectedPadding_Bottom = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_selected_padding_bottom, (int) mPadding_bottom);

        mUnSelectedPadding_Left = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_unselected_padding_left, (int) mPadding_left);
        mUnSelectedPadding_Right = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_unselected_padding_right, (int) mPadding_right);
        mUnSelectedPadding_Top = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_unselected_padding_top, (int) mPadding_top);
        mUnSelectedPadding_Bottom = attributes.getDimensionPixelSize(R.styleable.SliderPagerIndicator_slider_unselected_padding_bottom, (int) mPadding_bottom);
