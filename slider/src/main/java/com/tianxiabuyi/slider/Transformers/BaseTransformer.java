package com.tianxiabuyi.slider.Transformers;
 ...
 * <p>
 * BaseTransformer implement {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 * <p>
 * After you call setPageTransformer(), transformPage() will be called by {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx}
 * when your slider are animating.
 * <p>
 * In onPreTransform() function, that will make {@link com.tianxiabuyi.slider.Animations.BaseAnimationInterface}
 * work.
 * <p>
