package com.tianxiabuyi.slider;
...
import com.tianxiabuyi.slider.Animations.BaseAnimationInterface;
import com.tianxiabuyi.slider.Indicators.SliderPagerIndicator;
import com.tianxiabuyi.slider.SliderTypes.BaseSliderView;
import com.tianxiabuyi.slider.Transformers.AccordionTransformer;
import com.tianxiabuyi.slider.Transformers.BackgroundToForegroundTransformer;
import com.tianxiabuyi.slider.Transformers.BaseTransformer;
import com.tianxiabuyi.slider.Transformers.CubeInTransformer;
import com.tianxiabuyi.slider.Transformers.DefaultTransformer;
import com.tianxiabuyi.slider.Transformers.DepthPageTransformer;
import com.tianxiabuyi.slider.Transformers.FadeTransformer;
import com.tianxiabuyi.slider.Transformers.FlipHorizontalTransformer;
import com.tianxiabuyi.slider.Transformers.FlipPageViewTransformer;
import com.tianxiabuyi.slider.Transformers.ForegroundToBackgroundTransformer;
import com.tianxiabuyi.slider.Transformers.RotateDownTransformer;
import com.tianxiabuyi.slider.Transformers.RotateUpTransformer;
import com.tianxiabuyi.slider.Transformers.StackTransformer;
import com.tianxiabuyi.slider.Transformers.TabletTransformer;
import com.tianxiabuyi.slider.Transformers.ZoomInTransformer;
import com.tianxiabuyi.slider.Transformers.ZoomOutSlideTransformer;
import com.tianxiabuyi.slider.Transformers.ZoomOutTransformer;
import com.tianxiabuyi.slider.Tricks.FixedSpeedScroller;
import com.tianxiabuyi.slider.Tricks.InfinitePagerAdapter;
import com.tianxiabuyi.slider.Tricks.InfiniteViewPager;
import com.tianxiabuyi.slider.Tricks.ViewPagerEx;
...
public class SliderLayout extends RelativeLayout {
    ...
    /**
     * {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx} indicator.
     */
    private SliderPagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.tianxiabuyi.slider.Indicators.SliderPagerIndicator}
     */
    private SliderPagerIndicator.IndicatorVisibility mIndicatorVisibility = SliderPagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.tianxiabuyi.slider.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.tianxiabuyi.slider.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.tianxiabuyi.slider.Indicators.SliderPagerIndicator} shape, rect or oval.
     */
    ...
    public SliderLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.slider_Style);
    }
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.SliderLayout, defStyle, 0);

        mAutoCycle = attributes.getBoolean(
                R.styleable.SliderLayout_slider_auto_cycle, true);
        mTransformerSpan = attributes.getInteger(
                R.styleable.SliderLayout_slider_pager_animation_span, 1100);
        mTransformerId = attributes.getInt(
                R.styleable.SliderLayout_slider_pager_animation, Transformer.Default.ordinal());
        int visibility = attributes.getInt(
                R.styleable.SliderLayout_slider_indicator_visibility, 0);
        for (SliderPagerIndicator.IndicatorVisibility v : SliderPagerIndicator.IndicatorVisibility.values()) {
    ...
    public void setCustomIndicator(SliderPagerIndicator indicator) {
        if (mIndicator != null) {
     ...
     * {@link com.tianxiabuyi.slider.Animations.BaseAnimationInterface},
     * and you can see a example in {@link com.tianxiabuyi.slider.Animations.DescriptionAnimation}
     *
     * @param animation
     */
     ...
     * @param visibility
     */
    public void setIndicatorVisibility(SliderPagerIndicator.IndicatorVisibility visibility) {
        if (mIndicator == null) {
            return;
        }
    ...
    public SliderPagerIndicator.IndicatorVisibility getIndicatorVisibility() {
        if (mIndicator == null) {
            return mIndicator.getIndicatorVisibility();
        }
        return SliderPagerIndicator.IndicatorVisibility.Invisible;

    }

    /**
     * get the {@link com.tianxiabuyi.slider.Indicators.SliderPagerIndicator} instance.
     * You can manipulate the properties of the indicator.
     *
     * @return
     */
    public SliderPagerIndicator getPagerIndicator() {
        return mIndicator;
    }
    ...
    public void setPresetIndicator(PresetIndicators presetIndicator) {
        SliderPagerIndicator sliderPagerIndicator = (SliderPagerIndicator) findViewById(presetIndicator.getResourceId());
        setCustomIndicator(sliderPagerIndicator);
    }
